...
| Attendance (%)   | Class attendance rate          | Independent |
| Previous Scores  | Past academic performance      | Independent |
| Sleep Hours      | Average hours of sleep         | Independent |
...
| Adjusted R Square | 0.87  | Reliable model accuracy                   |
...
| --------------- | --------------------------- |
| Hours Studied   | Strong positive impact      |
| Attendance      | Significant positive effect |
...
| Attendance   | Maintain high attendance rate    |
